<template>
    ...
    <!-- <div class="header-section">
      ...
      <span class="menu">
        ...
        <ul class="header-primary-menu">
          ...
          <li class="nav-item" v-on:click="redirect('/login')">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto">
        <li class="nav-item" v-on:click="redirect('/signup')" data-toggle="collapse" data-target="#navbarSupportedContent">
          <span class="nav-link">Register</span>
        </li>
        <li class="nav-item" v-on:click="redirect('/login')" data-toggle="collapse" data-target="#navbarSupportedContent">
          <span class="nav-link">Login</span>
        </li>
      </ul>
    </div> -->
